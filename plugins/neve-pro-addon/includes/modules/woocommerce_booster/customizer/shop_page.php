...
class Shop_Page extends Base_Customizer {
	...
	/**
	 * Add shop section in customizer.
	 */
	private function add_shop_section() {
		$this->add_section(
			new Section(
				'neve_shop',
				array(
					'title'    => esc_html__( 'Shop', 'neve' ),
					'panel'    => 'neve_layout',
					'priority' => 60,
				)
			)
	...
	public function sanitize_image_hover( $value ) {
		$allowed_values = array( 'none', 'swipe', 'zoom' );
		if ( ! in_array( $value, $allowed_values, true ) ) {
			return 'none';
		}
