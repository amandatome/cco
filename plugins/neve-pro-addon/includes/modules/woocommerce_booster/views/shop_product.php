...
class Shop_Product extends Abstract_Shop_Product {
	...
	public function wrap_image_buttons() {
		...
		if ( $quick_view === 'none' && $button_display === 'none' ) {
			return;
		}
		$classes  = '';
		...
		echo '<a href="' . esc_url( get_permalink() ) . '" class="nv-product-overlay-link" tabindex="0" aria-label="' . esc_html( get_the_title() ) . ' ' . __( 'Product page', 'neve' ) . '">';
